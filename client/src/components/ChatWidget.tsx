...
export default function ChatWidget({ isOpen, onClose }: ChatWidgetProps) {
  ...
  return (
    ...
    >
      <div 
        className={`bg-white w-[90vw] h-[95vh] rounded-lg shadow-2xl flex flex-col overflow-hidden transition-transform duration-500 ease-in-out ${isAnimating ? 'translate-x-0' : 'translate-x-[105%]'}`} 
