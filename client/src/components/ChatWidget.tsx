          ...
          <div className="flex items-center gap-4">
            ...
            {customerName ? (
              <DropdownMenu>
                ...
                <DropdownMenuContent align="end" side="bottom" sideOffset={0} className="w-48 rounded-t-none" style={{ transform: 'translate(-15px, 48px)' }} container={chatModalRef.current || undefined}>
